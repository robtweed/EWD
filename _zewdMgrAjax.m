...
validSubnet(sessid)
 ...
 ;d trace^%zewdAPI("browserIP = "_browserIP)
...
saveMainConfig(sessid)
 ...
 . i '$d(^zewd("config","jsScriptPath","ewd")) s error=wlError q
...
configMainPrepage(sessid) ;
 ...
 d appendToList^%zewdAPI("frontEndTechnology","EWD/Node.js","ewd",sessid)
